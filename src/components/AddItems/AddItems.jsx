...
const AddItems = () => {
  ...
  <div className="max-w-4xl mx-auto">
    <div className={styles.formCard + ' bg-gradient-to-br from-[#f0fdf4] to-[#c7e9c0] shadow-2xl'}>
      <h2 className={styles.formTitle + ' text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-lime-400'}>
        Add New Menu Item
      </h2>
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              className={styles.inputField + ' bg-[#e6f4ea] text-[#2E4600] placeholder:text-green-600'}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              className={styles.inputField + ' h-32 sm:h-40 bg-[#e6f4ea] text-[#2E4600] placeholder:text-green-600'}
            ...
            <div>
              ...
              <div className={styles.relativeInput}>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={styles.inputField + ' pl-10 sm:pl-12 bg-[#e6f4ea] text-[#2E4600] placeholder:text-green-600'}
          ...
          <button
            type="submit"
            className={styles.actionBtn + ' bg-gradient-to-r from-[#6B8E23] to-[#9ACD32] text-white hover:scale-105'}
          >
            Add to Menu
          </button>
        </div>
